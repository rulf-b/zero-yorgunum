        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <Image src="/brands/lg.png" alt="LG Logo" width={120} height={80} className="object-contain" />
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              <span className="text-blue-600">LG</span> TV Tamiri İstanbul
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              İstanbul'un tüm ilçelerinde LG TV ekran tamiri ve değişimi. Aynı gün servis garantisi.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            LG TV Tamiri <span className="text-blue-600">İstanbul İlçeleri</span>
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {districts.map((district) => (
              <Link 
                key={district.slug}
                href={`/markalar/lg/istanbul/${district.slug}`}
              ...
              >
                ...
                <p className="text-sm text-gray-600 mt-1">LG TV Servisi</p>
              </Link>
            ))}
          </div>
        </div>
