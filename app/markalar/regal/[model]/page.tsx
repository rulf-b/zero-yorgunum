...
const RegalModelPage = () => {
  const params = useParams();
  const modelSlug = params.model as string;
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  // Regal modelleri listesi
  const regalModels = [
    "32R604H",
    "32R654HC",
    "32R654HCYR",
  ...
  return (
    <div className="pt-20 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Aradığınız Regal TV modeli bulunamadı.</p>
          <Link href="/markalar/regal">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white">
              Regal Modelleri Sayfasına Dön
            </Button>
          </Link>
        </div>
      </div>
  ...
  const faqs = [
    {
      question: `Regal ${currentModel} TV ekranı tamiri ne kadar sürer?`,
    ...
    },
    {
      ...
      answer: "Evet, Regal'nin yetkili servis partneri olarak tüm modeller için orijinal ekran ve yedek parçalarımız mevcuttur. Taklit veya uyumlu parça kullanmıyoruz."
    },
    {
      question: `Regal ${currentModel} tamiri için garanti veriyor musunuz?`,
      answer: "Evet, tüm Regal TV tamirlerimiz için 12 ay tam garanti veriyoruz. Bu garanti hem işçilik hem de kullandığımız orijinal parçaları kapsar."
    },
    {
      question: `${specs.size} ekran tamiri maliyeti nedir?`,
      answer: `${specs.size} Regal TV ekran tamiri maliyeti ekranın teknolojisine göre değişir. ${specs.technology} teknolojisi için özel fiyat teklifi alabilirsiniz. Ücretsiz keşif hizmeti sunuyoruz.`
    },
    {
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/markalar/regal" className="hover:text-blue-600">Regal</Link>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-4">
                <Image src="/marka_logo/regal.svg" alt="Regal Logo" width={60} height={40} className="object-contain mr-4" />
                <span className="text-lg text-gray-600">TV Tamiri</span>
              </div>
              
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                Regal <span className="text-blue-600">{currentModel}</span> Tamiri
              </h1>
              
              <p className="text-xl text-gray-600 mb-6">
                {specs.size} {specs.technology} teknolojili Regal TV'niz için profesyonel ekran tamiri. 
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href={`/ucretsiz-teklif?marka=Regal&model=${encodeURIComponent(currentModel)}`}>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-900">Regal</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Regal {currentModel} için <span className="text-blue-600">Servis Hizmetlerimiz</span>
          </h2>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">Sadece orijinal Regal parçaları</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-600" />
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Regal {currentModel} Tamiri İçin Hemen İletişime Geçin
          </h2>
