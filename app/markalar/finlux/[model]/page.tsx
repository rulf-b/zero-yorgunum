...
const FinluxModelPage = () => {
  const params = useParams();
  const modelSlug = params.model as string;
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  // Finlux modelleri listesi
  const finluxModels = [
    "32FX420H",
    "32FX420HB",
    "43FX670UW",
  ...
  const findModelFromSlug = (slug: string) => {
    return finluxModels.find(model => {
  ...
  return (
    <div className="pt-20 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Aradığınız Finlux TV modeli bulunamadı.</p>
          <Link href="/markalar/finlux">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white">
              Finlux Modelleri Sayfasına Dön
            </Button>
          </Link>
        </div>
      </div>
  ...
  const faqs = [
    {
      question: `Finlux ${currentModel} TV ekranı tamiri ne kadar sürer?`,
    ...
    },
    {
      ...
      answer: "Evet, Finlux'nin yetkili servis partneri olarak tüm modeller için orijinal ekran ve yedek parçalarımız mevcuttur. Taklit veya uyumlu parça kullanmıyoruz."
    },
    {
      question: `Finlux ${currentModel} tamiri için garanti veriyor musunuz?`,
      answer: "Evet, tüm Finlux TV tamirlerimiz için 12 ay tam garanti veriyoruz. Bu garanti hem işçilik hem de kullandığımız orijinal parçaları kapsar."
    },
    {
      question: `${specs.size} ekran tamiri maliyeti nedir?`,
      answer: `${specs.size} Finlux TV ekran tamiri maliyeti ekranın teknolojisine göre değişir. ${specs.technology} teknolojisi için özel fiyat teklifi alabilirsiniz. Ücretsiz keşif hizmeti sunuyoruz.`
    },
    {
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/markalar/finlux" className="hover:text-blue-600">Finlux</Link>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-4">
                <Image src="/marka_logo/finlux.svg" alt="Finlux Logo" width={60} height={40} className="object-contain mr-4" />
                <span className="text-lg text-gray-600">TV Tamiri</span>
              </div>
              
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                Finlux <span className="text-blue-600">{currentModel}</span> Tamiri
              </h1>
              
              <p className="text-xl text-gray-600 mb-6">
                {specs.size} {specs.technology} teknolojili Finlux TV'niz için profesyonel ekran tamiri. 
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href={`/ucretsiz-teklif?marka=Finlux&model=${encodeURIComponent(currentModel)}`}>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-900">Finlux</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Finlux {currentModel} için <span className="text-blue-600">Servis Hizmetlerimiz</span>
          </h2>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">Sadece orijinal Finlux parçaları</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-600" />
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Finlux {currentModel} Tamiri İçin Hemen İletişime Geçin
          </h2>
...
export default FinluxModelPage;