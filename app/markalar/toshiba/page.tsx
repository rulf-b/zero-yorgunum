...
const ToshibaPage = () => {
  ...
  const filteredModels = toshibaModels.filter(model =>
  ...
  return (
    <div className="pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <Image src="/marka_logo/toshiba.svg" alt="Toshiba Logo" width={120} height={80} className="object-contain" />
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              <span className="text-blue-600">Toshiba</span> TV Tamiri İstanbul
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              İstanbul genelinde Toshiba TV ekran tamiri ve değişimi. Aynı gün servis, orijinal parça, 12 ay garanti.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/ucretsiz-teklif?marka=Toshiba">
                <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-8">
                  Toshiba TV Teklifi Al
                </Button>
              </Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            İstanbul Toshiba TV <span className="text-blue-600">Servis Hizmetleri</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Sadece Toshiba orijinal yedek parçaları</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Toshiba TV için aynı gün tamiri</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Tüm ilçelerde Toshiba servisi</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Toshiba tamirinde tam garanti</p>
            </div>
          </div>

          <div className="bg-blue-50 p-6 rounded-lg text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Toshiba TV Tamiri Hakkında</h3>
            <p className="text-gray-600 mb-4">
              Toshiba televizyonunuzda meydana gelen ekran kırılması, arka aydınlatma sorunu, 
              renk bozukluğu ve tüm teknik arızalar için İstanbul genelinde hizmet vermekteyiz.
            </p>
            <p className="text-gray-600">
              Uzman teknisyen kadromuz ve orijinal Toshiba yedek parçalarımız ile 
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">
            Tamir Ettiğimiz <span className="text-blue-600">Toshiba TV Modelleri</span>
          </h2>
          <p className="text-center text-gray-600 mb-8">
            {toshibaModels.length} farklı Toshiba TV modelinde uzman servis hizmeti
          </p>
          ...
          <div className="max-w-md mx-auto mb-8">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Model ara... (örn: 24WL1A63DT)"
                value={searchTerm}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
            {currentModels.map((model, index) => (
              <Link 
                key={index} 
                href={`/markalar/toshiba/${createModelSlug(model)}`}
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-semibold text-gray-900 text-sm truncate">Toshiba {model}</h3>
                ...
                <div className="mt-3 flex justify-between items-center">
                  ...
                  <Button 
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      window.location.href = `/ucretsiz-teklif?marka=Toshiba&model=${encodeURIComponent(model)}`;
                    }}
                  >
                    Teklif Al
                  </Button>
          ...
          <div className="text-center text-gray-600 mb-8">
            <p>
              {filteredModels.length > 0 ? (
                ...
                `Toplam ${toshibaModels.length} model mevcut`
              )}
            </p>
          </div>
          ...
          {filteredModels.length === 0 && searchTerm && (
            <div className="text-center py-8 mb-8">
              ...
              <p className="text-sm text-gray-400 mt-2">
                Tüm Toshiba TV modelleri için servis hizmeti vermekteyiz. 
                <Link href="/ucretsiz-teklif?marka=Toshiba" className="text-blue-600 hover:underline ml-1">
                  Teklif alın
                </Link>
              </p>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg text-center mt-12">
            ...
            <p className="text-gray-600 mb-6">
              Listede olmayan tüm Toshiba TV modelleri için de profesyonel tamiri hizmeti sunuyoruz. 
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Toshiba TV Tamiri <span className="text-blue-600">Popüler İlçeler</span>
          </h2>
            ...
            {districts.map((district) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mt-1">Toshiba TV Tamiri</p>
                </div>
              );
            })}
          </div>
          <div className="text-center mt-8">
            <p className="text-gray-600 mb-4">Listelenen ilçelerde yakında Toshiba servisi başlatılacaktır.</p>
            <Link href="/ucretsiz-teklif?marka=Toshiba">
