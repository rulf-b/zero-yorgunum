...
// title: 'Samsung TV Tamiri Şile | Samsung Ekran Değişimi Şile Servisi'
// description: 'Şile'de Samsung TV ekran tamiri ve değişimi. Aynı gün Samsung TV servisi, orijinal parça, 12 ay garanti.'
// keywords: 'samsung tv tamiri sile, samsung ekran değişimi sile, sile samsung servisi'

const features = [
  {
    icon: MapPin,
    title: 'Şile Merkez Konumu',
    description: 'Şile ve çevresinde 30 dakikada Samsung TV tamiri'
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: 'Şile içinde aynı gün Samsung TV tamiri garantisi'
  },
  {
    icon: Star,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Şile'de profesyonel Samsung TV ekran tamiri ve değişimi. 
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">Şile Samsung Tamiri</div>
                </div>
                <div className="text-center">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Şile Samsung TV Servisi</h3>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <p className="text-sm text-gray-600">
                    Şile bölgesinde Samsung TV tamiri için güvenilir adres.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Şile Samsung TV <span className="text-blue-600">Servis Avantajları</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Şile'de <span className="text-blue-600">Samsung TV Tamiri</span>
              </h2>
              <div className="space-y-4">
                <p className="text-gray-600">
                  Şile bölgesinde Samsung TV tamiri hizmeti veriyoruz. 
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-blue-900 mb-2">Samsung Şile Servis Avantajları:</h3>
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Şile <span className="text-blue-600">Samsung Servis Bilgileri</span>
              </h2>
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-6">
            Şile'de Samsung TV'niz Bozuldu mu?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Şile bölgesinde Samsung TV için aynı gün servis, orijinal parça garantisi ve 12 ay garanti.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/ucretsiz-teklif?marka=Samsung&konum=Şile">
              <Button size="lg" variant="secondary" className="px-8 py-4">
                Şile Samsung TV Teklifi Al
              </Button>
            </Link>
            <a href={`tel:${siteSettings?.phone?.replace(/\s/g, '') || '+905525587905'}`}>
