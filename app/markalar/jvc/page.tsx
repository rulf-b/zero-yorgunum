...
const JVCPage = () => {
  ...
  const [jvcModels, setJvcModels] = useState<string[]>([]);
  ...
  useEffect(() => {
    ...
    fetch('/api/tv-models')
      ...
      .then(data => {
        const models = data
          .filter((item: any) => item.brand === 'JVC')
      ...
      .catch(err => {
        console.error('JVC modelleri yüklenemedi:', err);
        setLoading(false);
      });
  }, []);
  const districts = [
  ...
  const filteredModels = jvcModels.filter(model =>
  ...
  return (
    <div className="pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              <span className="text-blue-600">JVC</span> TV Tamiri İstanbul
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              İstanbul genelinde JVC TV ekran tamiri ve değişimi. Aynı gün servis, orijinal parça, 12 ay garanti.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/ucretsiz-teklif?marka=JVC">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            İstanbul JVC TV <span className="text-blue-600">Servis Hizmetleri</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Sadece JVC orijinal yedek parçaları</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">JVC TV için aynı gün tamiri</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Tüm ilçelerde JVC servisi</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">JVC tamirinde tam garanti</p>
            </div>
          </div>

          <div className="bg-blue-50 p-6 rounded-lg text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">JVC TV Tamiri Hakkında</h3>
            <p className="text-gray-600 mb-4">
              JVC televizyonunuzda meydana gelen ekran kırılması, arka aydınlatma sorunu, 
              renk bozukluğu ve tüm teknik arızalar için İstanbul genelinde hizmet vermekteyiz.
            </p>
            <p className="text-gray-600">
              Uzman teknisyen kadromuz ve orijinal JVC yedek parçalarımız ile 
      ...
      {/* JVC TV Modelleri Bölümü */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">
            Tamir Ettiğimiz <span className="text-blue-600">JVC TV Modelleri</span>
          </h2>
          <p className="text-center text-gray-600 mb-8">
            {loading ? 'Modeller yükleniyor...' : `${jvcModels.length} farklı JVC TV modelinde uzman servis hizmeti`}
          </p>

          {!loading && jvcModels.length > 0 && (
            <>
              <div className="max-w-md mx-auto mb-8">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Model ara... (örn: LT-55VA3005T)"
                    value={searchTerm}
                  ...
                  >
                    ...
                    <div className="mt-3 flex justify-between items-center">
                      ...
                      <Button 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          window.location.href = `/ucretsiz-teklif?marka=JVC&model=${encodeURIComponent(model)}`;
                        }}
                      >
                        Teklif Al
                      </Button>
              ...
              <div className="text-center mb-8">
                {filteredModels.length > 0 ? (
                  ...
                  <p className="text-gray-600 mb-4">
                    Aradığınız model bulunamadı. Tüm JVC TV modelleri için servis hizmeti vermekteyiz.
                  </p>
                ) : null}
              </div>
              ...
              {filteredModels.length === 0 && searchTerm && (
                <div className="bg-blue-50 p-6 rounded-lg text-center mb-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    Tüm JVC TV modelleri için servis hizmeti vermekteyiz. 
              ...
              <div className="bg-gray-50 p-6 rounded-lg text-center">
                <p className="text-gray-600 mb-4">
                  Listede olmayan tüm JVC TV modelleri için de profesyonel tamir hizmeti sunuyoruz. 
          ...
          {loading && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mt-4">JVC TV modelleri yükleniyor...</p>
            </div>
          )}

          {!loading && jvcModels.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-600 mb-4">JVC TV modelleri yüklenirken bir hata oluştu.</p>
              <Link href="/ucretsiz-teklif?marka=JVC">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white">
                  Teklif Al
                </Button>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            JVC TV Tamiri <span className="text-blue-600">Popüler İlçeler</span>
          </h2>
            ...
            {districts.map((district) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mt-1">JVC TV Tamiri</p>
                </div>
              );
            })}
          </div>
          <div className="text-center mt-8">
            <p className="text-gray-600 mb-4">Listelenen ilçelerde yakında JVC servisi başlatılacaktır.</p>
            <Link href="/ucretsiz-teklif?marka=JVC">
